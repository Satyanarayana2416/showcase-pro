...
export const skills = {
  ...
  "Web & Frameworks": ["React", "Node.js", "HTML / CSS", "Flask"],
  "AI & ML": ["Generative AI", "LLMs", "Gemini 2.5 Flash", "AI Agents", "MCP", "n8n"],
  "DevOps & Cloud": ["AWS", "Git / GitHub", "Linux / Unix"],
  "Data & Tools": ["Power BI", "MS Excel", "PostgreSQL", "Wireshark"],
  Concepts: ["Data Structures", "Algorithms", "Secure Coding", "Packet Analysis"],
};
...
export const experience = [
  {
    ...
    points: [
      "Hands-on with Wireshark, Social Engineering Toolkit, BeEF Framework.",
      "Performed packet analysis using Gen-AI to identify threats and vulnerabilities.",
    ],
  },
  {
    ...
    points: ["One-month hands-on internship in core cybersecurity concepts."],
  },
];
